            ...
            <div className='section1'>
                <div className='section1-main'>
                    ...
                    <div className='section-content'>
                        ...
                        <p>
                            <strong>Start Date:</strong> startDateTime
                        </p>
                        <p>
                            <strong>End Date:</strong> endDateTime
                        </p>
                    </div>
                </div>
                <img
                    className='event-image'
                    src='https://images.unsplash.com/photo-1576085898274-069be5a26c58?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzl8fGNvbmZlcmVuY2V8ZW58MHwxfDB8fHww&auto=format&fit=crop&w=800&q=60'
                    alt='conference'
                />
            </div>
                ...
                <div className='section-content'>
                    ...
                    <div className='booth'>
                        ...
                        <p className='booth-company'>
                            <a href='https://www.neste.com/'>Company name</a>
                        </p>
                    </div>
                </div>
            </div>
